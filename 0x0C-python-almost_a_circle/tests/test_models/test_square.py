...
Unittest classes:
    Square_Test_instantiation
    Square_Test_size
    Square_Test_x
    Square_Test_y
    Square_Test_order_of_initialization
    Square_Test_area
    Square_Test_stdout
    Square_Test_update_args
    Square_Test_update_kw_args
    Square_Test_to_dictionary
"""
import io
import sys
import unittest
...
class Square_Test_instantiation(unittest.TestCase):
    """testing the instantiation of the Square class"""
...
class Square_Test_size(unittest.TestCase):
    """testing the size initialization of the Square class"""
...
class Square_Test_x(unittest.TestCase):
    """testing the initialization of Square "x" attribute"""
...
class Square_Test_y(unittest.TestCase):
    """testing the initialization of Square "y" attribute"""
...
class Square_Test_order_of_initialization(unittest.TestCase):
    """testing the order of Square attribute initialization"""
...
class Square_Test_area(unittest.TestCase):
...
class Square_Test_stdout(unittest.TestCase):
    """testing the "__str__" and display methods of the Square class"""

    @staticmethod
    def capture_stdout(sq, method):
        """captures and returns the text printed to "stdout"
        args:
            sq (Square): Square to print to the "stdout"
            method (str): method to run on "sq"
        returns:
            printed text to the "stdout"
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
    ...
    def test_str_method_print_size(self):
        s = Square(4)
        capture = Square_Test_stdout.capture_stdout(s, "print")
    ...
    def test_display_size(self):
        s = Square(2, 0, 0, 9)
        capture = Square_Test_stdout.capture_stdout(s, "display")
        self.assertEqual("##\n##\n", capture.getvalue())
...
class Square_Test_update_args(unittest.TestCase):
    """testing the "update args" method of the Square class"""
...
class Square_Test_update_kw_args(unittest.TestCase):
    """testing the "update kw_args" method of Square class"""
    ...
    def test_update_kw_args_width_setter(self):
        s = Square(10, 10, 10, 10)
        s.update(id=89, size=8)
        self.assertEqual(8, s.width)

    def test_update_kw_args_height_setter(self):
        s = Square(10, 10, 10, 10)
    ...
    def test_update_kw_args_invalid_size(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "width must be an integer"):
            s.update(size="invalid")

    def test_update_kw_args_size_zero(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            s.update(size=0)

    def test_update_kw_args_size_negative(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(ValueError, "width must be > 0"):
            s.update(size=-3)

    def test_update_kw_args_invalid_x(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "x must be an integer"):
            s.update(x="invalid")
    ...
    def test_update_kw_args_invalid_y(self):
        s = Square(10, 10, 10, 10)
        with self.assertRaisesRegex(TypeError, "y must be an integer"):
            s.update(y="invalid")
...
class Square_Test_to_dictionary(unittest.TestCase):
    """testing the "to_dictionary" method of the Square class"""
